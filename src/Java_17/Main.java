package Java_17;// Java 프로그래밍 - 스트림
...
//      3-3. reduce -> map이랑 유사한 상태 , 연쇄적으로 합을 해서 데이터를 추출할 때 사용
        System.out.println("== reduce ==");
        Stream<Integer> stream4 =new ArrayList<Integer>(Arrays.asList(1,2,3,4,5)).stream();
        System.out.println(stream4.reduce((x , y) -> x+y).get());
